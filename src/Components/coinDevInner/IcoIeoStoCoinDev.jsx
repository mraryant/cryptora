...
const IcoIeoStoCoinDev = () => {
  ...
  const data5 = [
    ...
    {
      title: "Mintable",
      content:"Via minting, you will produce tokens. Only the owner of the token will mint. If you don't want to produce any more tokens, you can also disable minting.",
    },
...
export default IcoIeoStoCoinDev